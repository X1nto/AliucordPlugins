...
public class Stallman extends Plugin {
    ...
    public void start(Context context) {
        ApplicationCommandOption argument = new ApplicationCommandOption(ApplicationCommandType.STRING, "phrase", "A phrase to replace \"Linux\" with", null, true, true, null, null);
        commands.registerCommand(
            "stallman",
            "Replace \"Linux\" with your desired string",
            Collections.singletonList(argument),
            ctx -> {
                String desiredString = ctx.getRequiredString("phrase");
                String copypasta =
